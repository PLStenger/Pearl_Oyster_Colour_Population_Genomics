...
java -jar picard.jar CreateSequenceDictionary R=Pearl_Oyster_Colour_Population_Genomics/01_genome/sspace.final.scaffolds.fasta O=Pearl_Oyster_Colour_Population_Genomics/01_genome/sspace.final.scaffolds.dict
