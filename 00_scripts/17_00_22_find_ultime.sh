...
SCRIPT_R=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/00_scripts/17_00_22_find_ultime.R

Rscript --vanilla $SCRIPT_R >& ${SCRATCH}/17_00_22_find_ultime.out
