...
blast_formatter -archive ${BLAST_ARCHIVE} -out ${CB_LOG_FOLDER}/${OUT_FILE} -outfmt "6 qseqid sseqid sallseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore"
