...
DATADIRECTORY=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/08_input_pvalued_with_iteration
...
awk '{print $4}' $DATADIRECTORY/${FILE##*/} > $DATADIRECTORY/${FILE##*/}_SNP.txt
