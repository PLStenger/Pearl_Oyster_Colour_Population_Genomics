...
SCRIPT_R=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/00_scripts/17_glm_with_iterations/28_02_chord_diagramm.R

Rscript --vanilla $SCRIPT_R >& ${SCRIPT_FOLDER}/28_02_chord_diagramm.out
