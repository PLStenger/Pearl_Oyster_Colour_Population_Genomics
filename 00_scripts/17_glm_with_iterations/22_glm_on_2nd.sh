...
SCRIPT_R=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/00_scripts/17_glm_with_iterations/22_glm_on_2nd.R

Rscript --vanilla $SCRIPT_R 2>&1 ${SCRIPT_FOLDER}/22_glm_on_2nd.out
