...
SCRIPT_R=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/00_scripts/17_glm_with_iterations/37_histogram_AF.R

Rscript --vanilla $SCRIPT_R >&1 ${SCRIPT_FOLDER}/37_histogram_AF.out
