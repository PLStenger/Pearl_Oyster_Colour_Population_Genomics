...
SCRIPT_R=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/00_scripts/17_glm_with_iterations/36_PCA.R

Rscript --vanilla $SCRIPT_R >&1 ${SCRIPT_FOLDER}/36_PCA.out
