...
p1 <- grid.arrange(arrangeGrob(ggTakapotoVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
                               ggTakapotoVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggTakapotoVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggHatcheryVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggHatcheryVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggHatcheryVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_012 + theme(legend.position="none"),
                               nrow=3),
                   mylegend, nrow=2,heights=c(10, 1))

ggsave("snpSift_P_0_01.png", width = 30, height = 20)			    
			    
p2 <- grid.arrange(arrangeGrob(ggTakapotoVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
                               ggTakapotoVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggTakapotoVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggHatcheryVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggHatcheryVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggHatcheryVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_0012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_0012 + theme(legend.position="none"),
                               nrow=3),
                   mylegend, nrow=2,heights=c(10, 1))
...
ggsave("snpSift_P_0_001.png", width = 30, height = 20)			    
			    
p3 <- grid.arrange(arrangeGrob(ggHatcheryVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
                               ggHatcheryVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggHatcheryVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsHatchery_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggKatiuVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsKatiu_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggKatiuVsHatchery_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggYellowVsGreen_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggRedVsGreen_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggYellowVsRed_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
						 ggTakapotoVsGambier_OK_dat_P_0_0000012 + theme(legend.position="none"),
                               nrow=3),
                   mylegend, nrow=2,heights=c(10, 1))
...
ggsave("snpSift_P_0_000001.png", width = 30, height = 20)
