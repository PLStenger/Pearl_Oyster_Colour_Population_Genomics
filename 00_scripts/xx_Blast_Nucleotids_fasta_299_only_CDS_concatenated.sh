...
QUERY1=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/97_tests/Nucleotids_fasta_299_only_CDS_concatenated.fasta

OUT_FILE1=Nucleotids_fasta_299_only_CDS_concatenated_result_blast.txt
