...
SCRIPT_R=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/00_scripts/17_00_09_find_the_rererun.R

Rscript --vanilla $SCRIPT_R >& ${SCRATCH}/17_00_09_find_the_rererun.out
