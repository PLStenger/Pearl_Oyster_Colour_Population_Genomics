...
vcf <- read.table("individuals.vcf_DP20_maf0.1_miss1.vcf.recode_bcfm2M2v.vcf_decomposed_complex_no_header_inputRL_PL_split_6.txt")
...
for (i in 1:length(AF_pool9KV)){
  sink("AF_pool9KV_new_split_6.txt", append=TRUE)
...
AF_pool9KV_new <- read.table("AF_pool9KV_new_split_6.txt")
AF_pool9KV <- AF_pool9KV_new$V2
file.remove("AF_pool9KV_new_split_6.txt")

for (i in 1:length(AF_pool6GV)){
  sink("AF_pool6GV_new_split_6.txt", append=TRUE)
...
AF_pool6GV_new <- read.table("AF_pool6GV_new_split_6.txt")
AF_pool6GV <- AF_pool6GV_new$V2
file.remove("AF_pool6GV_new_split_6.txt")

for (i in 1:length(AF_pool4GR)){
  sink("AF_pool4GR_new_split_6.txt", append=TRUE)
...
AF_pool4GR_new <- read.table("AF_pool4GR_new_split_6.txt")
AF_pool4GR <- AF_pool4GR_new$V2
file.remove("AF_pool4GR_new_split_6.txt")

for (i in 1:length(AF_pool8KJ)){
  sink("AF_pool8KJ_new_split_6.txt", append=TRUE)
...
AF_pool8KJ_new <- read.table("AF_pool8KJ_new_split_6.txt")
AF_pool8KJ <- AF_pool8KJ_new$V2
file.remove("AF_pool8KJ_new_split_6.txt")

for (i in 1:length(AF_pool2TJ)){
  sink("AF_pool2TJ_new_split_6.txt", append=TRUE)
...
AF_pool2TJ_new <- read.table("AF_pool2TJ_new_split_6.txt")
AF_pool2TJ <- AF_pool2TJ_new$V2
file.remove("AF_pool2TJ_new_split_6.txt")

for (i in 1:length(AF_pool10ER)){
  sink("AF_pool10ER_new_split_6.txt", append=TRUE)
...
AF_pool10ER_new <- read.table("AF_pool10ER_new_split_6.txt")
AF_pool10ER <- AF_pool10ER_new$V2
file.remove("AF_pool10ER_new_split_6.txt")


for (i in 1:length(AF_pool5GJ )){
  sink("AF_pool5GJ_new_split_6.txt", append=TRUE)
...
AF_pool5GJ_new <- read.table("AF_pool5GJ_new_split_6.txt")
AF_pool5GJ  <- AF_pool5GJ_new$V2
file.remove("AF_pool5GJ_new_split_6.txt")

for (i in 1:length(AF_pool1TR)){
  sink("AF_pool1TR_new_split_6.txt", append=TRUE)
...
AF_pool1TR_new <- read.table("AF_pool1TR_new_split_6.txt")
AF_pool1TR <- AF_pool1TR_new$V2
file.remove("AF_pool1TR_new_split_6.txt")

for (i in 1:length(AF_pool7KR)){
  sink("AF_pool7KR_new_split_6.txt", append=TRUE)
...
AF_pool7KR_new <- read.table("AF_pool7KR_new_split_6.txt")
AF_pool7KR <- AF_pool7KR_new$V2
file.remove("AF_pool7KR_new_split_6.txt")


for (i in 1:length(AF_pool3TV)){
  sink("AF_pool3TV_new_split_6.txt", append=TRUE)
...
AF_pool3TV_new <- read.table("AF_pool3TV_new_split_6.txt")
AF_pool3TV <- AF_pool3TV_new$V2
file.remove("AF_pool3TV_new_split_6.txt")


for (i in 1:length(AF_pool11EJ)){
  sink("AF_pool11EJ_new_split_6.txt", append=TRUE)
...
AF_pool11EJ_new <- read.table("AF_pool11EJ_new_split_6.txt")
AF_pool11EJ <- AF_pool11EJ_new$V2
file.remove("AF_pool11EJ_new_split_6.txt")
...
sink("OutPutAnalysis_split_6.txt", append=TRUE)
...
for (i in 1:length(AF$SNP)){
  sink("OutPutAnalysisSNP_split_6.txt", append=TRUE)
...
SNP <- read.table("OutPutAnalysisSNP_split_6.txt")
#head(SNP)

Pvaleur <- read.table("OutPutAnalysis_split_6.txt")
#head(Pvaleur)
...
#head(dat)
write.table(dat, file = "results_split_6.csv", sep=";")
