...
sed -e 's/\ \ //g' iinput_glm_split_with_iteration_results_from_rerererererun_ultime_last.txt > input_glm_split_with_iteration_for_rererun_without_dbsp.txt
...
awk '$1=="10"' input_glm_split_with_iteration_for_rererun_without_dbsp_no_rt_scaf_dbsp_nb_line_merged.txt > input_glm_split_with_iteration_results_from_rerererererun_ultime_last_ok.txt

# If not 10 put in output_not_ok.txt
awk '$1!="10"' input_glm_split_with_iteration_for_rererun_without_dbsp_no_rt_scaf_dbsp_nb_line_merged.txt > input_glm_split_with_iteration_results_from_rerererererun_ultime_last_not_ok.txt
