...
######################################################################################################
# Avec correction de Bonferroni ## PVALUE 0.001
######################################################################################################
dat3 <- data.frame(dat$CHROM, dat$POS, dat$REF, dat$ALT,p.adjust(dat$raw_pval_VvsR, method = "bonferroni", n = length(dat$raw_pval_VvsR)), p.adjust(dat$raw_pval_VvsJ, method = "bonferroni", n = length(dat$raw_pval_VvsJ)), p.adjust(dat$raw_pval_RvsJ, method = "bonferroni", n = length(dat$raw_pval_RvsJ)))
colnames(dat3) <- c("CHROM", "POS", "REF", "ALT", "pval_VvsR_Bonf", "pval_VvsJ_Bonf", "pval_RvsJ_Bonf")
head(dat3)
...
write.table(dat4, "snp_ind_DP20_NoComplex_pval_VvsR_Bonf_Pvalue0.001.txt")
...
write.table(dat5, "snp_ind_DP20_NoComplex_pval_VvsJ_Bonf_Pvalue0.001.txt")
...
write.table(dat6, "snp_ind_DP20_NoComplex_pval_RvsJ_Bonf_Pvalue0.001.txt")
...
commun <- intersect(dat4.1$CHROM, dat5.1$CHROM)
length(commun) # 15
write.table(commun, "SNP_COMMUN_pval_VvsR_Bonf_and_pval_VvsJ_Bonf_Pvalue0.001.txt")

### SNP COMMUN ENTRE pval_VvsR_Bonf & pval_RvsJ_Bonf
# SNP propres au rouge
commun1 <- intersect(dat4.1$CHROM, dat6.1$CHROM)
length(commun1) # 31
write.table(commun1, "SNP_COMMUN_pval_VvsR_Bonf_and_pval_RvsJ_Bonf_Pvalue0.001.txt")
...
length(commun2) # 84
#length(Reduce(intersect, list(dat6.1$CHROM,dat5.1$CHROM)))
write.table(commun2, "SNP_COMMUN_pval_RvsJ_Bonf_and_pval_VvsJ_Bonf_Pvalue0.001.txt")
...
communTot2 <- intersect(commun, communTot)
length(communTot2) # 2
write.table(communTot2, "SNP_COMMUN_pval_RvsJ_Bonf_and_pval_VvsJ_Bonf_and_pval_VvsR_Bonf_Pvalue0.001.txt")
...
venn.diagram(
  list(pval_VvsR_Bonf = dat4.1$CHROM, pval_VvsJ_Bonf = dat5.1$CHROM, pval_RvsJ_Bonf=dat6.1$CHROM), 
  "Venn_pval_VvsR_Bonf_VS_pval_VvsJ_Bonf_VS_pval_RvsJ_Bonf_NoComplex_Pvalue0.001.tiff",
  fill = c("yellow","greenyellow","orange"),
  cat.col = c("yellow", "greenyellow", "orange"),
  euler.d = TRUE
)
...
all <-venn$..values..$"1"
write.table(all, "SNP_commun_a_tous_Pvalue0.001.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsJ_vs_RvsJ <-venn$..values..$"2"
write.table(VvsJ_vs_RvsJ, "SNP_commun_VvsJ_vs_RvsJ_Pvalue0.001.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR_vs_RvsJ <-venn$..values..$"3"
write.table(VvsR_vs_RvsJ, "SNP_commun_VvsR_vs_RvsJ_Pvalue0.001.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

RvsJ <-venn$..values..$"4"
write.table(RvsJ, "SNP_commun_RvsJ_Pvalue0.001.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR_vs_VvsJ <-venn$..values..$"5"
write.table(VvsR_vs_VvsJ, "SNP_commun_VvsR_vs_VvsJ_Pvalue0.001.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsJ <-venn$..values..$"6"
write.table(VvsJ, "SNP_commun_VvsJ_Pvalue0.001.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR <-venn$..values..$"7"
write.table(VvsR, "SNP_commun_VvsR_Pvalue0.001.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)
...
######################################################################################################
# Avec correction de Bonferroni ## PVALUE 0.01
######################################################################################################
dat3 <- data.frame(dat$CHROM, dat$POS, dat$REF, dat$ALT,p.adjust(dat$raw_pval_VvsR, method = "bonferroni", n = length(dat$raw_pval_VvsR)), p.adjust(dat$raw_pval_VvsJ, method = "bonferroni", n = length(dat$raw_pval_VvsJ)), p.adjust(dat$raw_pval_RvsJ, method = "bonferroni", n = length(dat$raw_pval_RvsJ)))
colnames(dat3) <- c("CHROM", "POS", "REF", "ALT", "pval_VvsR_Bonf", "pval_VvsJ_Bonf", "pval_RvsJ_Bonf")
head(dat3)
...
write.table(dat4, "snp_ind_DP20_NoComplex_pval_VvsR_Bonf_Pvalue0.01.txt")
...
write.table(dat5, "snp_ind_DP20_NoComplex_pval_VvsJ_Bonf_Pvalue0.01.txt")
...
write.table(dat6, "snp_ind_DP20_NoComplex_pval_RvsJ_Bonf_Pvalue0.01.txt")
...
commun <- intersect(dat4.1$CHROM, dat5.1$CHROM)
length(commun) # 15
write.table(commun, "SNP_COMMUN_pval_VvsR_Bonf_and_pval_VvsJ_Bonf_Pvalue0.01.txt")

### SNP COMMUN ENTRE pval_VvsR_Bonf & pval_RvsJ_Bonf
# SNP propres au rouge
commun1 <- intersect(dat4.1$CHROM, dat6.1$CHROM)
length(commun1) # 31
write.table(commun1, "SNP_COMMUN_pval_VvsR_Bonf_and_pval_RvsJ_Bonf_Pvalue0.01.txt")
...
length(commun2) # 84
#length(Reduce(intersect, list(dat6.1$CHROM,dat5.1$CHROM)))
write.table(commun2, "SNP_COMMUN_pval_RvsJ_Bonf_and_pval_VvsJ_Bonf_Pvalue0.01.txt")
...
communTot2 <- intersect(commun, communTot)
length(communTot2) # 2
write.table(communTot2, "SNP_COMMUN_pval_RvsJ_Bonf_and_pval_VvsJ_Bonf_and_pval_VvsR_Bonf_Pvalue0.01.txt")
...
venn.diagram(
  list(pval_VvsR_Bonf = dat4.1$CHROM, pval_VvsJ_Bonf = dat5.1$CHROM, pval_RvsJ_Bonf=dat6.1$CHROM), 
  "Venn_pval_VvsR_Bonf_VS_pval_VvsJ_Bonf_VS_pval_RvsJ_Bonf_NoComplex_Pvalue0.01.tiff",
  fill = c("yellow","greenyellow","orange"),
  cat.col = c("yellow", "greenyellow", "orange"),
  euler.d = TRUE
)
...
all <-venn$..values..$"1"
write.table(all, "SNP_commun_a_tous_Pvalue0.01.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsJ_vs_RvsJ <-venn$..values..$"2"
write.table(VvsJ_vs_RvsJ, "SNP_commun_VvsJ_vs_RvsJ_Pvalue0.01.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR_vs_RvsJ <-venn$..values..$"3"
write.table(VvsR_vs_RvsJ, "SNP_commun_VvsR_vs_RvsJ_Pvalue0.01.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

RvsJ <-venn$..values..$"4"
write.table(RvsJ, "SNP_commun_RvsJ_Pvalue0.01.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR_vs_VvsJ <-venn$..values..$"5"
write.table(VvsR_vs_VvsJ, "SNP_commun_VvsR_vs_VvsJ_Pvalue0.01.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsJ <-venn$..values..$"6"
write.table(VvsJ, "SNP_commun_VvsJ_Pvalue0.01.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR <-venn$..values..$"7"
write.table(VvsR, "SNP_commun_VvsR_Pvalue0.01.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)
...
######################################################################################################
# Avec correction de Bonferroni ## PVALUE 0.05
######################################################################################################
dat3 <- data.frame(dat$CHROM, dat$POS, dat$REF, dat$ALT,p.adjust(dat$raw_pval_VvsR, method = "bonferroni", n = length(dat$raw_pval_VvsR)), p.adjust(dat$raw_pval_VvsJ, method = "bonferroni", n = length(dat$raw_pval_VvsJ)), p.adjust(dat$raw_pval_RvsJ, method = "bonferroni", n = length(dat$raw_pval_RvsJ)))
colnames(dat3) <- c("CHROM", "POS", "REF", "ALT", "pval_VvsR_Bonf", "pval_VvsJ_Bonf", "pval_RvsJ_Bonf")
head(dat3)
...
write.table(dat4, "snp_ind_DP20_NoComplex_pval_VvsR_Bonf_Pvalue0.05.txt")
...
write.table(dat5, "snp_ind_DP20_NoComplex_pval_VvsJ_Bonf_Pvalue0.05.txt")
...
write.table(dat6, "snp_ind_DP20_NoComplex_pval_RvsJ_Bonf_Pvalue0.05.txt")
...
commun <- intersect(dat4.1$CHROM, dat5.1$CHROM)
length(commun) # 15
write.table(commun, "SNP_COMMUN_pval_VvsR_Bonf_and_pval_VvsJ_Bonf_Pvalue0.05.txt")

### SNP COMMUN ENTRE pval_VvsR_Bonf & pval_RvsJ_Bonf
# SNP propres au rouge
commun1 <- intersect(dat4.1$CHROM, dat6.1$CHROM)
length(commun1) # 31
write.table(commun1, "SNP_COMMUN_pval_VvsR_Bonf_and_pval_RvsJ_Bonf_Pvalue0.05.txt")
...
length(commun2) # 84
#length(Reduce(intersect, list(dat6.1$CHROM,dat5.1$CHROM)))
write.table(commun2, "SNP_COMMUN_pval_RvsJ_Bonf_and_pval_VvsJ_Bonf_Pvalue0.05.txt")
...
communTot2 <- intersect(commun, communTot)
length(communTot2) # 2
write.table(communTot2, "SNP_COMMUN_pval_RvsJ_Bonf_and_pval_VvsJ_Bonf_and_pval_VvsR_Bonf_Pvalue0.05.txt")
...
venn.diagram(
  list(pval_VvsR_Bonf = dat4.1$CHROM, pval_VvsJ_Bonf = dat5.1$CHROM, pval_RvsJ_Bonf=dat6.1$CHROM), 
  "Venn_pval_VvsR_Bonf_VS_pval_VvsJ_Bonf_VS_pval_RvsJ_Bonf_NoComplex_Pvalue0.05.tiff",
  fill = c("yellow","greenyellow","orange"),
  cat.col = c("yellow", "greenyellow", "orange"),
  euler.d = TRUE
)
...
all <-venn$..values..$"1"
write.table(all, "SNP_commun_a_tous_Pvalue0.05.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsJ_vs_RvsJ <-venn$..values..$"2"
write.table(VvsJ_vs_RvsJ, "SNP_commun_VvsJ_vs_RvsJ_Pvalue0.05.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR_vs_RvsJ <-venn$..values..$"3"
write.table(VvsR_vs_RvsJ, "SNP_commun_VvsR_vs_RvsJ_Pvalue0.05.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

RvsJ <-venn$..values..$"4"
write.table(RvsJ, "SNP_commun_RvsJ_Pvalue0.05.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR_vs_VvsJ <-venn$..values..$"5"
write.table(VvsR_vs_VvsJ, "SNP_commun_VvsR_vs_VvsJ_Pvalue0.05.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsJ <-venn$..values..$"6"
write.table(VvsJ, "SNP_commun_VvsJ_Pvalue0.05.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)

VvsR <-venn$..values..$"7"
write.table(VvsR, "SNP_commun_VvsR_Pvalue0.05.txt", quote=FALSE, row.names=FALSE, col.names=FALSE)
