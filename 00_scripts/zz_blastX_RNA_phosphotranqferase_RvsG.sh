...
QUERY=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/97_tests/phosphotranqferase_RvsG.fasta
...
OUT_FILE=phosphotransferase_RvsG_Blast.txt
