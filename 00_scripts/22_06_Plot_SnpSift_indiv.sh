...
SCRIPT_R=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/00_scripts/22_06_Plot_SnpSift_indiv.R

Rscript --vanilla $SCRIPT_R >& ${SCRIPT_FOLDER}/22_06_Plot_SnpSift_indiv.out
