...
SCRIPT_R=/home1/datawork/plstenge/Pearl_Oyster_Colour_Population_Genomics/00_scripts/17_00_09_split_glm_Tuckey.R

Rscript --vanilla $SCRIPT_R >& ${SCRATCH}/fichier2sortie_09_split_glm_Tuckey.out
