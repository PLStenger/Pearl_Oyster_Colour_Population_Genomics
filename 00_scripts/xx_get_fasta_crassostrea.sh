...
GFF=/home1/datawork/plstenge/crassostrea/X_Oyster_V9_AMP_sorted_gff_CDS.gff
...
bedtools getfasta -fi $GENOME_FASTA -bed $GFF -split > $DATADIRECTORY/X_Oyster_V9_AMP_sorted_gff_CDS.fasta
